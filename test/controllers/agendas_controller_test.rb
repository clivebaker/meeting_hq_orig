...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference("Agenda.count") do
      post agendas_url, params: { agenda: { meeting_id: @agenda.meeting_id, name: @agenda.name, position: @agenda.position, state: @agenda.state } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { meeting_id: @agenda.meeting_id, name: @agenda.name, position: @agenda.position, state: @agenda.state } }
