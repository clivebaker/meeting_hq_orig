...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference("Slide.count") do
      post slides_url, params: { slide: { data: @slide.data, enabled: @slide.enabled, meeting_id: @slide.meeting_id, name: @slide.name, slide_template_id: @slide.slide_template_id } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { data: @slide.data, enabled: @slide.enabled, meeting_id: @slide.meeting_id, name: @slide.name, slide_template_id: @slide.slide_template_id } }
