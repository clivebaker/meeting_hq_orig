...
%o`, message, error2, detail);
  ...
  var import_datatables2 = __toESM(require_dataTables_bootstrap5());
  var import_datatables3 = __toESM(require_dataTables_buttons());
  var import_buttons_html5 = __toESM(require_buttons_html5());
  var import_buttons_print = __toESM(require_buttons_print());
  var import_datatables4 = __toESM(require_buttons_bootstrap5());
  var import_datatables5 = __toESM(require_dataTables_responsive());
  var import_datatables6 = __toESM(require_dataTables_select());
  var import_datatables7 = __toESM(require_dataTables_fixedHeader());
  require_jquery();
  window.$ = window.JQuery = import_jquery.default;
  window.DataTable = (0, import_datatables2.default)();
})();
/*!
